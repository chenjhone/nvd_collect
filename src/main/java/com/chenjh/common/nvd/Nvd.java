 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://nvd.nist.gov/feeds/cve/1.2}entry" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="nvd_xml_version" use="required" type="{http://www.w3.org/2001/XMLSchema}NMTOKEN" />
 *       &lt;attribute name="pub_date" use="required" type="{http://nvd.nist.gov/feeds/cve/1.2}dateType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Nvd
{
     ...
     *     
     */
    public String getNvdXmlVersion()
    {
     ...
     *     
     */
    public void setNvdXmlVersion(String value)
    {
